...
def Save_Settings(self):
    ...
    try:
        ...
        self.logger.debug(f"Save_Settings : main : vulners_api_key : {'* IS NOT EMPTY * : ' + str(len(self.ui.api_key.text().strip())) + ' letters' if self.ui.api_key.text().strip() else 'EMPTY'}")
