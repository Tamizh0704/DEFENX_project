...
def Prepare_Window(self):
    ...
    # Set version
    #self.ui.app_ver.setText(f'<html><head/><body><p align="right"><a href=""><span style=" text-decoration: underline; color:#a9b7c6;">ver {self.app_version}</span></a></p></body></html>')
